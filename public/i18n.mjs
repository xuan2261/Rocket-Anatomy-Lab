...
const messages = {
  vi: {
    ...
    'anatomy.referenceLayerAria': 'Điểm tham chiếu giải phẫu NASA',
    'anatomy.searchLabel': 'Tìm trong giải phẫu',
    'anatomy.searchPlaceholder': 'LOX, J-2, Command Module…',
    'anatomy.searchCount': '{count} kết quả',
    'anatomy.searchEmpty': 'Không tìm thấy mục phù hợp',
    'anatomy.evidenceSummary': 'Nguồn & mức bằng chứng',
    'anatomy.evidenceSourceLabel': 'Nguồn',
    'anatomy.evidenceMappingLabel': 'Ánh xạ 3D',
    'anatomy.evidenceOfficial': 'Nguồn NASA chính thức',
    'anatomy.evidenceNote': 'Tên và mô tả đến từ nguồn NASA; vị trí marker/camera/mặt cắt là neo giáo dục trên GLB hiện tại.',
    'anatomy.copyLink': 'Sao chép liên kết mục này',
    'anatomy.copied': 'Đã sao chép liên kết',
    'anatomy.copyFailed': 'Không thể sao chép liên kết',
    ...
    'detail.aria': 'Lớp chi tiết 3D sơ đồ',
    'detail.kicker': 'CHI TIẾT 3D BỔ SUNG',
    'detail.title': 'Lớp sơ đồ 3D',
    'detail.show': 'Hiện',
    'detail.hide': 'Ẩn',
    'detail.compact': 'Gọn',
    'detail.exploded': 'Bóc tách',
    'detail.explodeAria': 'Mức bóc tách lớp chi tiết sơ đồ',
    'detail.off': 'Đang tắt',
    'detail.on': '{count} đối tượng tham chiếu · bóc tách {percent}%',
    'detail.note': 'Đây là hình học minh họa tương đối theo mô hình hiện tại, không phải geometry chế tạo hay kỹ thuật chính xác.',
    'detail.unavailable': 'Không khả dụng trong chế độ dự phòng',
  ...
  en: {
    ...
    'anatomy.referenceLayerAria': 'NASA anatomy reference point',
    'anatomy.searchLabel': 'Search anatomy',
    'anatomy.searchPlaceholder': 'LOX, J-2, Command Module…',
    'anatomy.searchCount': '{count} results',
    'anatomy.searchEmpty': 'No matching anatomy items',
    'anatomy.evidenceSummary': 'Source & evidence level',
    'anatomy.evidenceSourceLabel': 'Source',
    'anatomy.evidenceMappingLabel': '3D mapping',
    'anatomy.evidenceOfficial': 'Official NASA source',
    'anatomy.evidenceNote': 'Names and descriptions come from NASA sources; marker, camera and section positions are educational anchors on the current GLB.',
    'anatomy.copyLink': 'Copy link to this item',
    'anatomy.copied': 'Link copied',
    'anatomy.copyFailed': 'Could not copy link',
    ...
    'detail.aria': 'Schematic 3D detail layer',
    'detail.kicker': 'ADDITIONAL 3D DETAIL',
    'detail.title': '3D schematic layer',
    'detail.show': 'Show',
    'detail.hide': 'Hide',
    'detail.compact': 'Compact',
    'detail.exploded': 'Explode',
    'detail.explodeAria': 'Schematic detail explode amount',
    'detail.off': 'Off',
    'detail.on': '{count} reference objects · exploded {percent}%',
    'detail.note': 'This is relative educational geometry fitted to the current model, not manufacturing or engineering-accurate geometry.',
    'detail.unavailable': 'Unavailable in fallback mode',
