...
const messages = {
  vi: {
    ...
    'anatomy.realDetailKicker': 'MÔ HÌNH NASA THẬT',
    'anatomy.realDetailBadge': 'GLB đã xác minh',
    'anatomy.realDetailLoad': 'Tải chi tiết NASA',
    'anatomy.realDetailShow': 'Hiện chi tiết NASA',
    'anatomy.realDetailReady': 'Sẵn sàng tải theo yêu cầu',
    'anatomy.realDetailLoading': 'Đang tải mô hình NASA đã xác minh…',
    'anatomy.realDetailLoaded': 'Đã tải mô hình NASA thật · shell Saturn V chuyển sang bóng mờ',
    'anatomy.realDetailFailed': 'Không tải được mô hình chi tiết đã xác minh',
    'anatomy.realDetailNote': 'Geometry đến từ asset NASA đã ghim; vị trí/scale khi đặt vào Saturn V tổng thể vẫn là ánh xạ giáo dục gần đúng.',
    'anatomy.realDetailCompact': 'Gọn',
    'anatomy.realDetailExploded': 'Bóc tách',
    'anatomy.realDetailExplodeAria': 'Mức bóc tách các part NASA thật',
    'anatomy.realDetailPartsAria': 'Danh sách part NASA thật',
    'anatomy.realDetailParts': '{count} part nguồn NASA',
    'anatomy.realDetailPartVisible': 'Ẩn {name}',
    'anatomy.realDetailPartHidden': 'Hiện {name}',
    'anatomy.realDetailHide': 'Ẩn',
    'anatomy.realDetailShowPart': 'Hiện',
    'anatomy.partInspectorAria': 'Thanh tra part NASA',
    'anatomy.partInspectorKicker': 'PART ĐANG CHỌN',
    'anatomy.partInspectorSource': 'NASA source',
    'anatomy.partBreadcrumbAria': 'Đường dẫn part NASA',
    'anatomy.partFocus': 'Tập trung part',
    'anatomy.partGhost': 'Làm mờ part khác',
    'anatomy.partOnly': 'Chỉ hiện part này',
    'anatomy.partMeshes': 'Mesh',
    'anatomy.partTriangles': 'Tam giác',
    'anatomy.partDrawCalls': 'Draw calls ~',
    'anatomy.partBounds': 'Bounds',
    'anatomy.partProvenance': 'Nguồn: {file} · Git blob {sha}',
    'anatomy.partSelected': 'Đã chọn {name}',
    'anatomy.partNone': 'Chọn một part từ danh sách hoặc trực tiếp trên mô hình 3D',
  ...
  en: {
    ...
    'anatomy.realDetailKicker': 'REAL NASA MODEL',
    'anatomy.realDetailBadge': 'Verified GLB',
    'anatomy.realDetailLoad': 'Load NASA detail',
    'anatomy.realDetailShow': 'Show NASA detail',
    'anatomy.realDetailReady': 'Ready to load on demand',
    'anatomy.realDetailLoading': 'Loading the verified NASA model…',
    'anatomy.realDetailLoaded': 'Real NASA model loaded · Saturn V shell switched to ghost mode',
    'anatomy.realDetailFailed': 'Could not load the verified detail model',
    'anatomy.realDetailNote': 'Geometry comes from the pinned NASA asset; placement and scale inside the Saturn V overview remain an approximate educational mapping.',
    'anatomy.realDetailCompact': 'Compact',
    'anatomy.realDetailExploded': 'Explode',
    'anatomy.realDetailExplodeAria': 'Real NASA part explode amount',
    'anatomy.realDetailPartsAria': 'Real NASA source parts',
    'anatomy.realDetailParts': '{count} NASA source parts',
    'anatomy.realDetailPartVisible': 'Hide {name}',
    'anatomy.realDetailPartHidden': 'Show {name}',
    'anatomy.realDetailHide': 'Hide',
    'anatomy.realDetailShowPart': 'Show',
    'anatomy.partInspectorAria': 'NASA source-part inspector',
    'anatomy.partInspectorKicker': 'SELECTED PART',
    'anatomy.partInspectorSource': 'NASA source',
    'anatomy.partBreadcrumbAria': 'NASA part breadcrumb',
    'anatomy.partFocus': 'Focus part',
    'anatomy.partGhost': 'Ghost other parts',
    'anatomy.partOnly': 'Show only this part',
    'anatomy.partMeshes': 'Meshes',
    'anatomy.partTriangles': 'Triangles',
    'anatomy.partDrawCalls': 'Draw calls ~',
    'anatomy.partBounds': 'Bounds',
    'anatomy.partProvenance': 'Source: {file} · Git blob {sha}',
    'anatomy.partSelected': 'Selected {name}',
    'anatomy.partNone': 'Select a part from the list or directly in the 3D view',
